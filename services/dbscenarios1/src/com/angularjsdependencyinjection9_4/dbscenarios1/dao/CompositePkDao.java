...
/**
 * Specifies methods used to obtain and modify CompositePk related information
 * which is stored in the database.
 */
@Repository("dbscenarios1.CompositePkDao")
public class CompositePkDao extends WMGenericDaoImpl<CompositePk, CompositePkId> {
