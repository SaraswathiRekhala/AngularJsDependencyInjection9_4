...
import com.angularjsdependencyinjection9_4.dbscenarios1.VirtualTable;
import com.angularjsdependencyinjection9_4.dbscenarios1.VirtualTableId;
import com.angularjsdependencyinjection9_4.dbscenarios1.service.VirtualTableService;
...
public class VirtualTableController {
    ...
    @Autowired
	@Qualifier("dbscenarios1.VirtualTableService")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public VirtualTable getVirtualTable(@RequestParam("charCol") String charCol, @RequestParam("dateCol") Date dateCol, @RequestParam("doubleCol") BigDecimal doubleCol, @RequestParam("bigdecCol") BigDecimal bigdecCol, @RequestParam("stringCol") String stringCol, @RequestParam("shortcol") Short shortcol) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteVirtualTable(@RequestParam("charCol") String charCol, @RequestParam("dateCol") Date dateCol, @RequestParam("doubleCol") BigDecimal doubleCol, @RequestParam("bigdecCol") BigDecimal bigdecCol, @RequestParam("stringCol") String stringCol, @RequestParam("shortcol") Short shortcol) {
