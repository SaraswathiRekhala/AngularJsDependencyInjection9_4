...
import com.angularjsdependencyinjection9_4.dbscenarios1.service.TCompositesMany2one1Service;
...
public class TCompositesMany2one1Controller {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TCompositesMany2one1 getTCompositesMany2one1(@PathVariable("id") Integer id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TCompositesMany2one1 editTCompositesMany2one1(@PathVariable("id") Integer id, @RequestBody TCompositesMany2one1 tcompositesMany2one1) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteTCompositesMany2one1(@PathVariable("id") Integer id) {
    ...
    public Page<TCompositesMany2one1> searchTCompositesMany2one1sByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering TCompositesMany2one1s list by query filter:{}", (Object) queryFilters);
    ...
    public Page<TCompositesMany2one1> findTCompositesMany2one1s(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering TCompositesMany2one1s list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportTCompositesMany2one1sAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = TCompositesMany2one1.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> tCompositesMany2one1Service.export(exportOptions, pageable, outputStream));
