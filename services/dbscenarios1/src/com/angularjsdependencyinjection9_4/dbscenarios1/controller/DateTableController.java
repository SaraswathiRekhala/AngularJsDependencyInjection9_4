...
import com.angularjsdependencyinjection9_4.dbscenarios1.service.DateTableService;
...
public class DateTableController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public DateTable getDateTable(@PathVariable("id") Integer id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public DateTable editDateTable(@PathVariable("id") Integer id, @RequestBody DateTable dateTable) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteDateTable(@PathVariable("id") Integer id) {
    ...
    public Page<DateTable> searchDateTablesByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering DateTables list by query filter:{}", (Object) queryFilters);
    ...
    public Page<DateTable> findDateTables(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering DateTables list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportDateTablesAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = DateTable.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> dateTableService.export(exportOptions, pageable, outputStream));
