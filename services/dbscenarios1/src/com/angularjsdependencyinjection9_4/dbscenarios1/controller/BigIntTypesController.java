...
import com.angularjsdependencyinjection9_4.dbscenarios1.service.BigIntTypesService;
...
public class BigIntTypesController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public BigIntTypes getBigIntTypes(@PathVariable("id") Long id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public BigIntTypes editBigIntTypes(@PathVariable("id") Long id, @RequestBody BigIntTypes bigIntTypes) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteBigIntTypes(@PathVariable("id") Long id) {
    ...
    public Page<BigIntTypes> searchBigIntTypesByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering BigIntTypes list by query filter:{}", (Object) queryFilters);
    ...
    public Page<BigIntTypes> findBigIntTypes(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering BigIntTypes list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportBigIntTypesAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = BigIntTypes.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> bigIntTypesService.export(exportOptions, pageable, outputStream));
