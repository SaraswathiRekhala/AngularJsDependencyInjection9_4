...
import com.angularjsdependencyinjection9_4.dbscenarios1.service.PersonsService;
 ...
 * @see Persons
 */
@RestController("dbscenarios1.PersonsController")
@Api(value = "PersonsController", description = "Exposes APIs to work with Persons resource.")
@RequestMapping("/dbscenarios1/Persons")
public class PersonsController {

    private static final Logger LOGGER = LoggerFactory.getLogger(PersonsController.class);

    @Autowired
	@Qualifier("dbscenarios1.PersonsService")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Persons getPersons(@PathVariable("id") Integer id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Persons editPersons(@PathVariable("id") Integer id, @RequestBody Persons persons) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deletePersons(@PathVariable("id") Integer id) {
