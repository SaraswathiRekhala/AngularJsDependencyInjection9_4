...
import com.angularjsdependencyinjection9_4.dbscenarios1.Table8;
import com.angularjsdependencyinjection9_4.dbscenarios1.service.Table8Service;
...
public class Table8Controller {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table8 editTable8(@PathVariable("id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) {
        Table8 newTable8 = WMMultipartUtils.toObject(multipartHttpServletRequest, Table8.class, "dbscenarios1");
        newTable8.setId(id);
