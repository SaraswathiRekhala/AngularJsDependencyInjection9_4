...
import com.angularjsdependencyinjection9_4.dbscenarios1.service.TOne2oneCompositesService;
...
public class TOne2oneCompositesController {
    ...
    @Autowired
	@Qualifier("dbscenarios1.TOne2oneCompositesService")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TOne2oneComposites getTOne2oneComposites(@RequestParam("shortId") Short shortId, @RequestParam("stringId") String stringId, @RequestParam("byteId") Short byteId, @RequestParam("charId") String charId) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TOne2oneComposites editTOne2oneComposites(@RequestParam("shortId") Short shortId, @RequestParam("stringId") String stringId, @RequestParam("byteId") Short byteId, @RequestParam("charId") String charId, @RequestBody TOne2oneComposites tone2oneComposites) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteTOne2oneComposites(@RequestParam("shortId") Short shortId, @RequestParam("stringId") String stringId, @RequestParam("byteId") Short byteId, @RequestParam("charId") String charId) {
    ...
    public Page<TOne2oneComposites> searchTOne2oneCompositesByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering TOne2oneComposites list by query filter:{}", (Object) queryFilters);
    ...
    public Page<TOne2oneComposites> findTOne2oneComposites(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering TOne2oneComposites list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportTOne2oneCompositesAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = TOne2oneComposites.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> tOne2oneCompositesService.export(exportOptions, pageable, outputStream));
