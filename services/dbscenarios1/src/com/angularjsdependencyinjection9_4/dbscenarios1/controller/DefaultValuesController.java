...
import com.angularjsdependencyinjection9_4.dbscenarios1.DefaultValues;
import com.angularjsdependencyinjection9_4.dbscenarios1.service.DefaultValuesService;
...
public class DefaultValuesController {
    ...
    @Autowired
	@Qualifier("dbscenarios1.DefaultValuesService")
    ...
    public DefaultValues editDefaultValues(@PathVariable("id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) {
        DefaultValues newDefaultValues = WMMultipartUtils.toObject(multipartHttpServletRequest, DefaultValues.class, "dbscenarios1");
