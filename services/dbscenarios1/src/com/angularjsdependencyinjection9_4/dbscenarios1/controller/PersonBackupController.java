...
import com.angularjsdependencyinjection9_4.dbscenarios1.service.PersonBackupService;
...
public class PersonBackupController {
    ...
    @Autowired
	@Qualifier("dbscenarios1.PersonBackupService")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public PersonBackup getPersonBackup(@PathVariable("id") Integer id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public PersonBackup editPersonBackup(@PathVariable("id") Integer id, @RequestBody PersonBackup personBackup) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deletePersonBackup(@PathVariable("id") Integer id) {
