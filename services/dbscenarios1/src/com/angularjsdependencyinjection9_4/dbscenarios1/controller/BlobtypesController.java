...
import com.angularjsdependencyinjection9_4.dbscenarios1.service.BlobtypesService;
...
public class BlobtypesController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Blobtypes getBlobtypes(@PathVariable("id") Integer id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Blobtypes editBlobtypes(@PathVariable("id") Integer id, @RequestBody Blobtypes blobtypes) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Blobtypes editBlobtypes(@PathVariable("id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) {
        Blobtypes newBlobtypes = WMMultipartUtils.toObject(multipartHttpServletRequest, Blobtypes.class, "dbscenarios1");
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteBlobtypes(@PathVariable("id") Integer id) {
    ...
    public Page<Blobtypes> searchBlobtypesByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering Blobtypes list by query filter:{}", (Object) queryFilters);
    ...
    public Page<Blobtypes> findBlobtypes(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering Blobtypes list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportBlobtypesAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = Blobtypes.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> blobtypesService.export(exportOptions, pageable, outputStream));
