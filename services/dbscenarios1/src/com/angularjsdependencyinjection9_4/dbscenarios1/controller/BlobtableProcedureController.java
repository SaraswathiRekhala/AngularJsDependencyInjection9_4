...
import com.angularjsdependencyinjection9_4.dbscenarios1.BlobtableProcedure;
import com.angularjsdependencyinjection9_4.dbscenarios1.service.BlobtableProcedureService;
...
public class BlobtableProcedureController {
    ...
    @Autowired
	@Qualifier("dbscenarios1.BlobtableProcedureService")
    ...
    public BlobtableProcedure editBlobtableProcedure(@PathVariable("id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) {
        BlobtableProcedure newBlobtableProcedure = WMMultipartUtils.toObject(multipartHttpServletRequest, BlobtableProcedure.class, "dbscenarios1");
