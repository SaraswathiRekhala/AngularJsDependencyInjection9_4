...
import com.angularjsdependencyinjection9_4.dbscenarios1.service.SampleTableService;
...
public class SampleTableController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public SampleTable getSampleTable(@RequestParam("intId") Integer intId, @RequestParam("dateId") Date dateId) {

        SampleTableId sampletableId = new SampleTableId();
        sampletableId.setIntId(intId);
        sampletableId.setDateId(dateId);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public SampleTable editSampleTable(@RequestParam("intId") Integer intId, @RequestParam("dateId") Date dateId, @RequestBody SampleTable sampleTable) {

        sampleTable.setIntId(intId);
        sampleTable.setDateId(dateId);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteSampleTable(@RequestParam("intId") Integer intId, @RequestParam("dateId") Date dateId) {
