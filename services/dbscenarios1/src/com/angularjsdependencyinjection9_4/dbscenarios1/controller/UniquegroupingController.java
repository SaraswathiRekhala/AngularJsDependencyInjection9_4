...
import com.angularjsdependencyinjection9_4.dbscenarios1.service.UniquegroupingService;
...
public class UniquegroupingController {
    ...
    @Autowired
	@Qualifier("dbscenarios1.UniquegroupingService")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Uniquegrouping getUniquegrouping(@PathVariable("id") Integer id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Uniquegrouping editUniquegrouping(@PathVariable("id") Integer id, @RequestBody Uniquegrouping uniquegrouping) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteUniquegrouping(@PathVariable("id") Integer id) {
    ...
    public Page<Uniquegrouping> searchUniquegroupingsByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering Uniquegroupings list by query filter:{}", (Object) queryFilters);
    ...
    public Page<Uniquegrouping> findUniquegroupings(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering Uniquegroupings list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportUniquegroupingsAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = Uniquegrouping.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> uniquegroupingService.export(exportOptions, pageable, outputStream));
