...
import com.angularjsdependencyinjection9_4.dbscenarios1.service.Table11Service;
...
public class Table11Controller {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table11 getTable11(@RequestParam("id") String id, @RequestParam("column2") String column2) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table11 editTable11(@RequestParam("id") String id, @RequestParam("column2") String column2, @RequestBody Table11 table11) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteTable11(@RequestParam("id") String id, @RequestParam("column2") String column2) {
