...
import com.angularjsdependencyinjection9_4.dbscenarios1.service.NewTableService;
...
public class NewTableController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public NewTable getNewTable(@RequestParam("id") Integer id, @RequestParam("stringcol_45_") String stringcol_45_, @RequestParam("datecol1") Date datecol1) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public NewTable editNewTable(@RequestParam("id") Integer id, @RequestParam("stringcol_45_") String stringcol_45_, @RequestParam("datecol1") Date datecol1, @RequestBody NewTable newTable) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteNewTable(@RequestParam("id") Integer id, @RequestParam("stringcol_45_") String stringcol_45_, @RequestParam("datecol1") Date datecol1) {
    ...
    public Page<NewTable> searchNewTablesByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering NewTables list by query filter:{}", (Object) queryFilters);
    ...
    public Page<NewTable> findNewTables(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering NewTables list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportNewTablesAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = NewTable.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> newTableService.export(exportOptions, pageable, outputStream));
