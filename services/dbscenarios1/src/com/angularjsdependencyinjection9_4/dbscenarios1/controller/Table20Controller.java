...
import com.angularjsdependencyinjection9_4.dbscenarios1.service.Table20Service;
...
public class Table20Controller {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table20 getTable20(@PathVariable("id") Integer id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table20 editTable20(@PathVariable("id") Integer id, @RequestBody Table20 table20) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table20 editTable20(@PathVariable("id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) {
        Table20 newTable20 = WMMultipartUtils.toObject(multipartHttpServletRequest, Table20.class, "dbscenarios1");
        newTable20.setId(id);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteTable20(@PathVariable("id") Integer id) {
    ...
    public Page<Table20> searchTable20sByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering Table20s list by query filter:{}", (Object) queryFilters);
    ...
    public Page<Table20> findTable20s(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering Table20s list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportTable20sAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = Table20.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> table20Service.export(exportOptions, pageable, outputStream));
