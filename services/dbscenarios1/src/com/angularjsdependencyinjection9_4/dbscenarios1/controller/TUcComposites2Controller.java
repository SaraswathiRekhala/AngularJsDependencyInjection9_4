...
import com.angularjsdependencyinjection9_4.dbscenarios1.service.TUcComposites2Service;
...
public class TUcComposites2Controller {
    ...
    @Autowired
	@Qualifier("dbscenarios1.TUcComposites2Service")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TUcComposites2 getTUcComposites2(@RequestParam("shortCol") Short shortCol, @RequestParam("byteId") Short byteId, @RequestParam("charCol") String charCol, @RequestParam("stringCol") String stringCol) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TUcComposites2 editTUcComposites2(@RequestParam("shortCol") Short shortCol, @RequestParam("byteId") Short byteId, @RequestParam("charCol") String charCol, @RequestParam("stringCol") String stringCol, @RequestBody TUcComposites2 tucComposites2) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteTUcComposites2(@RequestParam("shortCol") Short shortCol, @RequestParam("byteId") Short byteId, @RequestParam("charCol") String charCol, @RequestParam("stringCol") String stringCol) {
    ...
    public Page<TUcComposites2> searchTUcComposites2sByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering TUcComposites2s list by query filter:{}", (Object) queryFilters);
    ...
    public Page<TUcComposites2> findTUcComposites2s(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering TUcComposites2s list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportTUcComposites2sAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = TUcComposites2.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> tUcComposites2Service.export(exportOptions, pageable, outputStream));
