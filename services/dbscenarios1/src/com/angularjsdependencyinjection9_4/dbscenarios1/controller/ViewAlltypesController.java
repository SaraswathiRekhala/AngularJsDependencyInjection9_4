...
import com.angularjsdependencyinjection9_4.dbscenarios1.service.ViewAlltypesService;
...
public class ViewAlltypesController {
    ...
    @Autowired
	@Qualifier("dbscenarios1.ViewAlltypesService")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public void getViewAlltypesBLOBContent(@RequestParam("pkId") Integer pkId, @RequestParam("byteCol") Short byteCol, @RequestParam("shortCol") Short shortCol, @RequestParam("intCol") Integer intCol, @RequestParam("longCol") Long longCol, @RequestParam("floatCol") Double floatCol, @RequestParam("doubleCol") BigDecimal doubleCol, @RequestParam("bigdecCol") BigDecimal bigdecCol, @RequestParam("bigintCol") Long bigintCol, @RequestParam("charCol") String charCol, @RequestParam("stringCol") String stringCol, @RequestParam("textCol") String textCol, @RequestParam("clobCol") String clobCol, @RequestParam("dateCol") Date dateCol, @RequestParam("timeCol") Time timeCol, @RequestParam("datetimeCol") LocalDateTime datetimeCol, @RequestParam("timestampCol") Timestamp timestampCol, @RequestParam("booleanCol") Boolean booleanCol, @RequestParam("blobCol") byte[] blobCol, @PathVariable("fieldName") String fieldName, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public ViewAlltypes editViewAlltypes(@RequestParam("pkId") Integer pkId, @RequestParam("byteCol") Short byteCol, @RequestParam("shortCol") Short shortCol, @RequestParam("intCol") Integer intCol, @RequestParam("longCol") Long longCol, @RequestParam("floatCol") Double floatCol, @RequestParam("doubleCol") BigDecimal doubleCol, @RequestParam("bigdecCol") BigDecimal bigdecCol, @RequestParam("bigintCol") Long bigintCol, @RequestParam("charCol") String charCol, @RequestParam("stringCol") String stringCol, @RequestParam("textCol") String textCol, @RequestParam("clobCol") String clobCol, @RequestParam("dateCol") Date dateCol, @RequestParam("timeCol") Time timeCol, @RequestParam("datetimeCol") LocalDateTime datetimeCol, @RequestParam("timestampCol") Timestamp timestampCol, @RequestParam("booleanCol") Boolean booleanCol, @RequestParam("blobCol") byte[] blobCol, @RequestBody ViewAlltypes viewAlltypes) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public ViewAlltypes editViewAlltypes(@RequestParam("pkId") Integer pkId, @RequestParam("byteCol") Short byteCol, @RequestParam("shortCol") Short shortCol, @RequestParam("intCol") Integer intCol, @RequestParam("longCol") Long longCol, @RequestParam("floatCol") Double floatCol, @RequestParam("doubleCol") BigDecimal doubleCol, @RequestParam("bigdecCol") BigDecimal bigdecCol, @RequestParam("bigintCol") Long bigintCol, @RequestParam("charCol") String charCol, @RequestParam("stringCol") String stringCol, @RequestParam("textCol") String textCol, @RequestParam("clobCol") String clobCol, @RequestParam("dateCol") Date dateCol, @RequestParam("timeCol") Time timeCol, @RequestParam("datetimeCol") LocalDateTime datetimeCol, @RequestParam("timestampCol") Timestamp timestampCol, @RequestParam("booleanCol") Boolean booleanCol, @RequestParam("blobCol") byte[] blobCol, MultipartHttpServletRequest multipartHttpServletRequest) {
    ...
    public ViewAlltypes editViewAlltypesAndMultiparts(@RequestParam("pkId") Integer pkId, @RequestParam("byteCol") Short byteCol, @RequestParam("shortCol") Short shortCol, @RequestParam("intCol") Integer intCol, @RequestParam("longCol") Long longCol, @RequestParam("floatCol") Double floatCol, @RequestParam("doubleCol") BigDecimal doubleCol, @RequestParam("bigdecCol") BigDecimal bigdecCol, @RequestParam("bigintCol") Long bigintCol, @RequestParam("charCol") String charCol, @RequestParam("stringCol") String stringCol, @RequestParam("textCol") String textCol, @RequestParam("clobCol") String clobCol, @RequestParam("dateCol") Date dateCol, @RequestParam("timeCol") Time timeCol, @RequestParam("datetimeCol") LocalDateTime datetimeCol, @RequestParam("timestampCol") Timestamp timestampCol, @RequestParam("booleanCol") Boolean booleanCol, @RequestParam("blobCol") byte[] blobCol, MultipartHttpServletRequest multipartHttpServletRequest) { 
        ...
        ViewAlltypes newViewAlltypes = WMMultipartUtils.toObject(multipartHttpServletRequest, ViewAlltypes.class, "dbscenarios1");
