...
import com.angularjsdependencyinjection9_4.dbscenarios1.service.TUcOne2oneChildService;
...
public class TUcOne2oneChildController {
    ...
    @Autowired
	@Qualifier("dbscenarios1.TUcOne2oneChildService")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TUcOne2oneChild getTUcOne2oneChild(@PathVariable("id") Short id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TUcOne2oneChild editTUcOne2oneChild(@PathVariable("id") Short id, @RequestBody TUcOne2oneChild tucOne2oneChild) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteTUcOne2oneChild(@PathVariable("id") Short id) {
    ...
    public Page<TUcOne2oneChild> searchTUcOne2oneChildsByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering TUcOne2oneChilds list by query filter:{}", (Object) queryFilters);
    ...
    public Page<TUcOne2oneChild> findTUcOne2oneChilds(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering TUcOne2oneChilds list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportTUcOne2oneChildsAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = TUcOne2oneChild.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> tUcOne2oneChildService.export(exportOptions, pageable, outputStream));
