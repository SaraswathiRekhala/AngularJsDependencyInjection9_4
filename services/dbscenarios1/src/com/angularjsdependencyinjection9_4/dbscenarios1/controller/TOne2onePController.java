...
import com.angularjsdependencyinjection9_4.dbscenarios1.service.TOne2onePService;
...
public class TOne2onePController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TOne2oneP getTOne2oneP(@PathVariable("id") Short id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TOne2oneP editTOne2oneP(@PathVariable("id") Short id, @RequestBody TOne2oneP tone2oneP) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TOne2oneP editTOne2oneP(@PathVariable("id") Short id, MultipartHttpServletRequest multipartHttpServletRequest) {
        TOne2oneP newTOne2oneP = WMMultipartUtils.toObject(multipartHttpServletRequest, TOne2oneP.class, "dbscenarios1");
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteTOne2oneP(@PathVariable("id") Short id) {
    ...
    public Page<TOne2oneP> searchTOne2onePsByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering TOne2onePs list by query filter:{}", (Object) queryFilters);
    ...
    public Page<TOne2oneP> findTOne2onePs(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering TOne2onePs list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportTOne2onePsAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = TOne2oneP.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> tOne2onePService.export(exportOptions, pageable, outputStream));
