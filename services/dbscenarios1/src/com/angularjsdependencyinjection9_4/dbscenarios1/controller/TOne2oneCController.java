...
import com.angularjsdependencyinjection9_4.dbscenarios1.service.TOne2oneCService;
...
public class TOne2oneCController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TOne2oneC getTOne2oneC(@PathVariable("id") Short id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TOne2oneC editTOne2oneC(@PathVariable("id") Short id, @RequestBody TOne2oneC tone2oneC) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteTOne2oneC(@PathVariable("id") Short id) {
