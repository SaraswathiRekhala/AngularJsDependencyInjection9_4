...
import com.angularjsdependencyinjection9_4.dbscenarios1.service.TUcComposites1Service;
...
public class TUcComposites1Controller {
    ...
    @Autowired
	@Qualifier("dbscenarios1.TUcComposites1Service")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TUcComposites1 getTUcComposites1(@PathVariable("id") Integer id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TUcComposites1 editTUcComposites1(@PathVariable("id") Integer id, @RequestBody TUcComposites1 tucComposites1) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TUcComposites1 editTUcComposites1(@PathVariable("id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) {
        TUcComposites1 newTUcComposites1 = WMMultipartUtils.toObject(multipartHttpServletRequest, TUcComposites1.class, "dbscenarios1");
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteTUcComposites1(@PathVariable("id") Integer id) {
    ...
    public Page<TUcComposites1> searchTUcComposites1sByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering TUcComposites1s list by query filter:{}", (Object) queryFilters);
    ...
    public Page<TUcComposites1> findTUcComposites1s(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering TUcComposites1s list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportTUcComposites1sAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = TUcComposites1.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> tUcComposites1Service.export(exportOptions, pageable, outputStream));
