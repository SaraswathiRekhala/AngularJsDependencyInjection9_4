...
import com.angularjsdependencyinjection9_4.dbscenarios1.service.AllTypesWithoutSpaceService;
...
public class AllTypesWithoutSpaceController {
    ...
    @Autowired
	@Qualifier("dbscenarios1.AllTypesWithoutSpaceService")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public AllTypesWithoutSpace getAllTypesWithoutSpace(@PathVariable("id") Integer id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public AllTypesWithoutSpace editAllTypesWithoutSpace(@PathVariable("id") Integer id, @RequestBody AllTypesWithoutSpace allTypesWithoutSpace) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public AllTypesWithoutSpace editAllTypesWithoutSpace(@PathVariable("id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) {
        AllTypesWithoutSpace newAllTypesWithoutSpace = WMMultipartUtils.toObject(multipartHttpServletRequest, AllTypesWithoutSpace.class, "dbscenarios1");
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteAllTypesWithoutSpace(@PathVariable("id") Integer id) {
    ...
    public Page<AllTypesWithoutSpace> searchAllTypesWithoutSpacesByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering AllTypesWithoutSpaces list by query filter:{}", (Object) queryFilters);
    ...
    public Page<AllTypesWithoutSpace> findAllTypesWithoutSpaces(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering AllTypesWithoutSpaces list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportAllTypesWithoutSpacesAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = AllTypesWithoutSpace.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> allTypesWithoutSpaceService.export(exportOptions, pageable, outputStream));
