...
import com.angularjsdependencyinjection9_4.dbscenarios1.service.DatabaseDefinedTableService;
...
public class DatabaseDefinedTableController {
    ...
    @Autowired
	@Qualifier("dbscenarios1.DatabaseDefinedTableService")
    ...
    public DatabaseDefinedTable createDatabaseDefinedTable(@RequestBody DatabaseDefinedTable databaseDefinedTable) {
    ...
    @ApiOperation(value = "Returns the DatabaseDefinedTable instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.GET)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public DatabaseDefinedTable getDatabaseDefinedTable(@PathVariable("id") Integer id) {
        LOGGER.debug("Getting DatabaseDefinedTable with id: {}" , id);

        DatabaseDefinedTable foundDatabaseDefinedTable = databaseDefinedTableService.getById(id);
        LOGGER.debug("DatabaseDefinedTable details with id: {}" , foundDatabaseDefinedTable);

        return foundDatabaseDefinedTable;
    }

    @ApiOperation(value = "Updates the DatabaseDefinedTable instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.PUT)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public DatabaseDefinedTable editDatabaseDefinedTable(@PathVariable("id") Integer id, @RequestBody DatabaseDefinedTable databaseDefinedTable) {
        LOGGER.debug("Editing DatabaseDefinedTable with id: {}" , databaseDefinedTable.getIntegerCol());

        databaseDefinedTable.setIntegerCol(id);
        databaseDefinedTable = databaseDefinedTableService.update(databaseDefinedTable);
        LOGGER.debug("DatabaseDefinedTable details with id: {}" , databaseDefinedTable);

        return databaseDefinedTable;
    }

    @ApiOperation(value = "Deletes the DatabaseDefinedTable instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.DELETE)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteDatabaseDefinedTable(@PathVariable("id") Integer id) {
        LOGGER.debug("Deleting DatabaseDefinedTable with id: {}" , id);

        DatabaseDefinedTable deletedDatabaseDefinedTable = databaseDefinedTableService.delete(id);

        return deletedDatabaseDefinedTable != null;
    }
