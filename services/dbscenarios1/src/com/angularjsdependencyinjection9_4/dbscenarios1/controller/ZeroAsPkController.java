...
import com.angularjsdependencyinjection9_4.dbscenarios1.ZeroAsPk;
import com.angularjsdependencyinjection9_4.dbscenarios1.service.ZeroAsPkService;
...
public class ZeroAsPkController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public ZeroAsPk editZeroAsPk(@PathVariable("id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) {
        ZeroAsPk newZeroAsPk = WMMultipartUtils.toObject(multipartHttpServletRequest, ZeroAsPk.class, "dbscenarios1");
