...
import com.angularjsdependencyinjection9_4.dbscenarios1.service.DepartmentService;
 ...
 * @see Department
 */
@RestController("dbscenarios1.DepartmentController")
@Api(value = "DepartmentController", description = "Exposes APIs to work with Department resource.")
@RequestMapping("/dbscenarios1/Department")
public class DepartmentController {

    private static final Logger LOGGER = LoggerFactory.getLogger(DepartmentController.class);

    @Autowired
	@Qualifier("dbscenarios1.DepartmentService")
