...
import com.angularjsdependencyinjection9_4.dbscenarios1.service.DatetimeTableService;
...
public class DatetimeTableController {
    ...
    @Autowired
	@Qualifier("dbscenarios1.DatetimeTableService")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public DatetimeTable getDatetimeTable(@PathVariable("id") Integer id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public DatetimeTable editDatetimeTable(@PathVariable("id") Integer id, @RequestBody DatetimeTable datetimeTable) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteDatetimeTable(@PathVariable("id") Integer id) {
    ...
    public Page<DatetimeTable> searchDatetimeTablesByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering DatetimeTables list by query filter:{}", (Object) queryFilters);
    ...
    public Page<DatetimeTable> findDatetimeTables(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering DatetimeTables list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportDatetimeTablesAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = DatetimeTable.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> datetimeTableService.export(exportOptions, pageable, outputStream));
