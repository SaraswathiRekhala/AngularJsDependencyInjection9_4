...
import com.angularjsdependencyinjection9_4.dbscenarios1.UserLogin;
import com.angularjsdependencyinjection9_4.dbscenarios1.service.UserLoginService;
 ...
 * @see UserLogin
 */
@RestController("dbscenarios1.UserLoginController")
@Api(value = "UserLoginController", description = "Exposes APIs to work with UserLogin resource.")
@RequestMapping("/dbscenarios1/UserLogin")
public class UserLoginController {

    private static final Logger LOGGER = LoggerFactory.getLogger(UserLoginController.class);

    @Autowired
	@Qualifier("dbscenarios1.UserLoginService")
    ...
    public UserLogin editUserLogin(@PathVariable("id") Short id, MultipartHttpServletRequest multipartHttpServletRequest) {
        UserLogin newUserLogin = WMMultipartUtils.toObject(multipartHttpServletRequest, UserLogin.class, "dbscenarios1");
