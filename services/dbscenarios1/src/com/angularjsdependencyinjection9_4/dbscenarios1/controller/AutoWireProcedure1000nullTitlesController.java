...
import com.angularjsdependencyinjection9_4.dbscenarios1.service.AutoWireProcedure1000nullTitlesService;
 ...
 */
@RestController("dbscenarios1.AutoWireProcedure1000nullTitlesController")
...
@RequestMapping("/dbscenarios1/AutoWireProcedure1000nullTitles")
public class AutoWireProcedure1000nullTitlesController {
    ...
    @Autowired
	@Qualifier("dbscenarios1.AutoWireProcedure1000nullTitlesService")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public AutoWireProcedure1000nullTitles getAutoWireProcedure1000nullTitles(@PathVariable("id") Integer id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public AutoWireProcedure1000nullTitles editAutoWireProcedure1000nullTitles(@PathVariable("id") Integer id, @RequestBody AutoWireProcedure1000nullTitles autoWireProcedure1000nullTitles) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteAutoWireProcedure1000nullTitles(@PathVariable("id") Integer id) {
