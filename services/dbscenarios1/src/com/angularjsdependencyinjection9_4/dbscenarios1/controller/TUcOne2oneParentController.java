...
import com.angularjsdependencyinjection9_4.dbscenarios1.service.TUcOne2oneParentService;
...
public class TUcOne2oneParentController {
    ...
    @Autowired
	@Qualifier("dbscenarios1.TUcOne2oneParentService")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TUcOne2oneParent getTUcOne2oneParent(@PathVariable("id") Integer id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TUcOne2oneParent editTUcOne2oneParent(@PathVariable("id") Integer id, @RequestBody TUcOne2oneParent tucOne2oneParent) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteTUcOne2oneParent(@PathVariable("id") Integer id) {
    ...
    public Page<TUcOne2oneParent> searchTUcOne2oneParentsByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering TUcOne2oneParents list by query filter:{}", (Object) queryFilters);
    ...
    public Page<TUcOne2oneParent> findTUcOne2oneParents(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering TUcOne2oneParents list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportTUcOne2oneParentsAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = TUcOne2oneParent.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> tUcOne2oneParentService.export(exportOptions, pageable, outputStream));
