...
public class AllTypesWithoutSpace implements Serializable {
    ...
    private Integer intcol = 121;
    private Double floatcol = 121.1210D;
    private Long longcol = 1L;
    private BigDecimal doublecol;
    private Long bigintcol = 21787L;
    private BigDecimal bigdeccol;
    private String charcol = "S";
    private String stringcol = "TESTING STRING";
