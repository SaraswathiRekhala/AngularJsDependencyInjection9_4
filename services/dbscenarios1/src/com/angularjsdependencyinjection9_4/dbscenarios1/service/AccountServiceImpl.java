 ...
 * @see Account
 */
@Service("dbscenarios1.AccountService")
@Validated
public class AccountServiceImpl implements AccountService {
    ...
    @Autowired
    @Qualifier("dbscenarios1.AccountDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbscenarios1 for table Account to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service dbscenarios1 for table Account to {} format", options.getExportType());
