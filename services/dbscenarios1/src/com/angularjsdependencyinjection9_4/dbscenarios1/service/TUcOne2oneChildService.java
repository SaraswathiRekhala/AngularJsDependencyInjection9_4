...
public interface TUcOne2oneChildService {
     ...
     */
    TUcOne2oneChild getById(Short tucone2onechildId);
	...
	/**
     * Find and return the list of TUcOne2oneChilds by given id's.
     *
     ...
     *
     * @param tucone2onechildIds The id's of the TUcOne2oneChild to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return TUcOne2oneChilds associated with the given tucone2onechildIds.
     */
    List<TUcOne2oneChild> findByMultipleIds(List<Short> tucone2onechildIds, boolean orderedReturn);
     ...
     */
    TUcOne2oneChild update(@Valid TUcOne2oneChild tucOne2oneChild);
     ...
     */
    TUcOne2oneChild delete(Short tucone2onechildId);

    /**
     * Deletes an existing TUcOne2oneChild with the given object.
     *
     * @param tucOne2oneChild The instance of the TUcOne2oneChild to be deleted; value cannot be null.
     */
    void delete(TUcOne2oneChild tucOne2oneChild);
