...
public interface VirtualTableService {
     ...
     */
    VirtualTable getById(VirtualTableId virtualtableId);
     ...
     */
    List<VirtualTable> findByMultipleIds(List<VirtualTableId> virtualtableIds, boolean orderedReturn);
     ...
     */
    VirtualTable getByStringColAndDateCol(String stringCol, Date dateCol);
     ...
     * @throws EntityNotFoundException if no matching VirtualTable found.
     */
    VirtualTable getByCharCol(String charCol);
     ...
     */
    VirtualTable delete(VirtualTableId virtualtableId);
