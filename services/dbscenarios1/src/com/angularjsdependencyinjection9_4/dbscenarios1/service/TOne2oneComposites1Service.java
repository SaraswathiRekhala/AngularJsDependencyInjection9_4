...
public interface TOne2oneComposites1Service {
     ...
     */
    TOne2oneComposites1 getById(TOne2oneComposites1Id tone2onecomposites1Id);
	...
	/**
     * Find and return the list of TOne2oneComposites1s by given id's.
     *
     ...
     *
     * @param tone2onecomposites1Ids The id's of the TOne2oneComposites1 to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return TOne2oneComposites1s associated with the given tone2onecomposites1Ids.
     */
    List<TOne2oneComposites1> findByMultipleIds(List<TOne2oneComposites1Id> tone2onecomposites1Ids, boolean orderedReturn);
     ...
     */
    TOne2oneComposites1 update(@Valid TOne2oneComposites1 tone2oneComposites1);
     ...
     */
    TOne2oneComposites1 delete(TOne2oneComposites1Id tone2onecomposites1Id);

    /**
     * Deletes an existing TOne2oneComposites1 with the given object.
     *
     * @param tone2oneComposites1 The instance of the TOne2oneComposites1 to be deleted; value cannot be null.
     */
    void delete(TOne2oneComposites1 tone2oneComposites1);
