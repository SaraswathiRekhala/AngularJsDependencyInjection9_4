 ...
 */
@Service("dbscenarios1.TOne2oneCompositesService")
@Validated
public class TOne2oneCompositesServiceImpl implements TOne2oneCompositesService {
    ...
    @Autowired
    @Qualifier("dbscenarios1.TOne2oneCompositesDao")
    ...
    public TOne2oneComposites create(TOne2oneComposites tone2oneComposites) {
        ...
        return this.wmGenericDao.refresh(tone2oneCompositesCreated);
    }

    @Transactional(readOnly = true, value = "dbscenarios1TransactionManager")
    @Override
    public TOne2oneComposites getById(TOne2oneComposites1Id tone2onecompositesId) {
    ...
    public TOne2oneComposites findById(TOne2oneComposites1Id tone2onecompositesId) {
        ...
        try {
            ...
            LOGGER.debug("No TOne2oneComposites found with id: {}", tone2onecompositesId, ex);
            return null;
        }
    }
    ...
    @Transactional(readOnly = true, value = "dbscenarios1TransactionManager")
    @Override
    public List<TOne2oneComposites> findByMultipleIds(List<TOne2oneComposites1Id> tone2onecompositesIds, boolean orderedReturn) {
        LOGGER.debug("Finding TOne2oneComposites by ids: {}", tone2onecompositesIds);

        return this.wmGenericDao.findByMultipleIds(tone2onecompositesIds, orderedReturn);
    }


    @Transactional(rollbackFor = EntityNotFoundException.class, value = "dbscenarios1TransactionManager")
    @Override
    public TOne2oneComposites update(TOne2oneComposites tone2oneComposites) {
        LOGGER.debug("Updating TOne2oneComposites with information: {}", tone2oneComposites);

        this.wmGenericDao.update(tone2oneComposites);
        this.wmGenericDao.refresh(tone2oneComposites);
    ...
    @Transactional(value = "dbscenarios1TransactionManager")
    @Override
    public TOne2oneComposites delete(TOne2oneComposites1Id tone2onecompositesId) {
    ...
    @Transactional(value = "dbscenarios1TransactionManager")
    @Override
    public void delete(TOne2oneComposites tone2oneComposites) {
        LOGGER.debug("Deleting TOne2oneComposites with {}", tone2oneComposites);
        this.wmGenericDao.delete(tone2oneComposites);
    }
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbscenarios1 for table TOne2oneComposites to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service dbscenarios1 for table TOne2oneComposites to {} format", options.getExportType());
