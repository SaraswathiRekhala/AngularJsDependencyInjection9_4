 ...
 * @see ZeroAsPk
 */
@Service("dbscenarios1.ZeroAsPkService")
@Validated
public class ZeroAsPkServiceImpl implements ZeroAsPkService {
    ...
    @Autowired
    @Qualifier("dbscenarios1.ZeroAsPkDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbscenarios1 for table ZeroAsPk to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service dbscenarios1 for table ZeroAsPk to {} format", options.getExportType());
