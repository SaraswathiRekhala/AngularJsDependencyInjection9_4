...
public interface BlobtypesService {
     ...
     */
    Blobtypes getById(Integer blobtypesId);
	...
	/**
     * Find and return the list of Blobtypes by given id's.
     *
     ...
     *
     * @param blobtypesIds The id's of the Blobtypes to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return Blobtypes associated with the given blobtypesIds.
     */
    List<Blobtypes> findByMultipleIds(List<Integer> blobtypesIds, boolean orderedReturn);
     ...
     */
    Blobtypes update(@Valid Blobtypes blobtypes);
     ...
     */
    Blobtypes delete(Integer blobtypesId);

    /**
     * Deletes an existing Blobtypes with the given object.
     *
     * @param blobtypes The instance of the Blobtypes to be deleted; value cannot be null.
     */
    void delete(Blobtypes blobtypes);
