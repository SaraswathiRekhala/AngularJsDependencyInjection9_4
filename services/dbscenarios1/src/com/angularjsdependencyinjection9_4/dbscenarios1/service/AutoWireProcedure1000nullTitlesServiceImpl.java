 ...
 */
@Service("dbscenarios1.AutoWireProcedure1000nullTitlesService")
@Validated
public class AutoWireProcedure1000nullTitlesServiceImpl implements AutoWireProcedure1000nullTitlesService {
    ...
    @Autowired
    @Qualifier("dbscenarios1.AutoWireProcedure1000nullTitlesDao")
    ...
    @Override
    public AutoWireProcedure1000nullTitles getById(Integer autowireprocedure1000nulltitlesId) {
    ...
    @Transactional(readOnly = true, value = "dbscenarios1TransactionManager")
    @Override
    public List<AutoWireProcedure1000nullTitles> findByMultipleIds(List<Integer> autowireprocedure1000nulltitlesIds, boolean orderedReturn) {
    ...
    @Transactional(value = "dbscenarios1TransactionManager")
    @Override
    public AutoWireProcedure1000nullTitles delete(Integer autowireprocedure1000nulltitlesId) {
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbscenarios1 for table AutoWireProcedure1000nullTitles to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service dbscenarios1 for table AutoWireProcedure1000nullTitles to {} format", options.getExportType());
