 ...
 * @see DefaultValues
 */
@Service("dbscenarios1.DefaultValuesService")
@Validated
public class DefaultValuesServiceImpl implements DefaultValuesService {
    ...
    @Autowired
    @Qualifier("dbscenarios1.DefaultValuesDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbscenarios1 for table DefaultValues to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service dbscenarios1 for table DefaultValues to {} format", options.getExportType());
