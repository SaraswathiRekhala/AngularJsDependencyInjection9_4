 ...
 * @see Table8
 */
@Service("dbscenarios1.Table8Service")
@Validated
public class Table8ServiceImpl implements Table8Service {
    ...
    @Autowired
    @Qualifier("dbscenarios1.Table8Dao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbscenarios1 for table Table8 to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service dbscenarios1 for table Table8 to {} format", options.getExportType());
