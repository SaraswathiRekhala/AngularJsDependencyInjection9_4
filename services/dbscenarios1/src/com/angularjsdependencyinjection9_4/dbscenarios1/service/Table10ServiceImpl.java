...
import com.angularjsdependencyinjection9_4.dbscenarios1.Table10;
 ...
 * @see Table10
 */
@Service("dbscenarios1.Table10Service")
@Validated
public class Table10ServiceImpl implements Table10Service {
    ...
    @Autowired
    @Qualifier("dbscenarios1.Table10Dao")
    ...
    public Table10 getByColumn2AndColumn3(String column2, String column3) {
        ...
        return this.wmGenericDao.findByUniqueKey(column2AndColumn3Map);
    }
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbscenarios1 for table Table10 to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service dbscenarios1 for table Table10 to {} format", options.getExportType());
