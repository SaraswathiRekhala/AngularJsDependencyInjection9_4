...
public interface UniquegroupingService {
     ...
     */
    Uniquegrouping getById(Integer uniquegroupingId);
	...
	/**
     * Find and return the list of Uniquegroupings by given id's.
     *
     ...
     *
     * @param uniquegroupingIds The id's of the Uniquegrouping to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return Uniquegroupings associated with the given uniquegroupingIds.
     */
    List<Uniquegrouping> findByMultipleIds(List<Integer> uniquegroupingIds, boolean orderedReturn);
     ...
     */
    Uniquegrouping getByDatecolAndCharcol(Date datecol, String charcol);
     ...
     * @throws EntityNotFoundException if no matching Uniquegrouping found.
     */
    Uniquegrouping getByStringcol(String stringcol);
     ...
     * @throws EntityNotFoundException if no matching Uniquegrouping found.
     */
    Uniquegrouping getByDatecolAndCharcolAndDatetimecol(Date datecol, String charcol, LocalDateTime datetimecol);
     ...
     */
    Uniquegrouping update(@Valid Uniquegrouping uniquegrouping);
     ...
     */
    Uniquegrouping delete(Integer uniquegroupingId);

    /**
     * Deletes an existing Uniquegrouping with the given object.
     *
     * @param uniquegrouping The instance of the Uniquegrouping to be deleted; value cannot be null.
     */
    void delete(Uniquegrouping uniquegrouping);
