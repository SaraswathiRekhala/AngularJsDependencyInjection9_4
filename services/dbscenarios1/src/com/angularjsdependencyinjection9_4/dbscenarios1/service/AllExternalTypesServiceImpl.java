 ...
 */
@Service("dbscenarios1.AllExternalTypesService")
@Validated
public class AllExternalTypesServiceImpl implements AllExternalTypesService {
    ...
    @Autowired
    @Qualifier("dbscenarios1.AllExternalTypesDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbscenarios1 for table AllExternalTypes to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service dbscenarios1 for table AllExternalTypes to {} format", options.getExportType());
