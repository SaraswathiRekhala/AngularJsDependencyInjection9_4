...
public interface TimestampColService {
     ...
     */
    TimestampCol getById(Integer timestampcolId);
	...
	/**
     * Find and return the list of TimestampCols by given id's.
     *
     ...
     *
     * @param timestampcolIds The id's of the TimestampCol to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return TimestampCols associated with the given timestampcolIds.
     */
    List<TimestampCol> findByMultipleIds(List<Integer> timestampcolIds, boolean orderedReturn);
     ...
     */
    TimestampCol update(@Valid TimestampCol timestampCol);
     ...
     */
    TimestampCol delete(Integer timestampcolId);

    /**
     * Deletes an existing TimestampCol with the given object.
     *
     * @param timestampCol The instance of the TimestampCol to be deleted; value cannot be null.
     */
    void delete(TimestampCol timestampCol);
