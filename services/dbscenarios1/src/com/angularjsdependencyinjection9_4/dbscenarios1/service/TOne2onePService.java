...
public interface TOne2onePService {
     ...
     */
    TOne2oneP getById(Short tone2onepId);
     ...
     */
    List<TOne2oneP> findByMultipleIds(List<Short> tone2onepIds, boolean orderedReturn);
     ...
     */
    TOne2oneP getBySerialCol(long serialCol);
     ...
     */
    TOne2oneP delete(Short tone2onepId);
