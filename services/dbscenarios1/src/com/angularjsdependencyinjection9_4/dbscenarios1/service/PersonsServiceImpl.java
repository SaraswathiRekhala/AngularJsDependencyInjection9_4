 ...
 * @see Persons
 */
@Service("dbscenarios1.PersonsService")
@Validated
public class PersonsServiceImpl implements PersonsService {
    ...
    @Autowired
    @Qualifier("dbscenarios1.PersonsDao")
    ...
    @Override
    public Persons getById(Integer personsId) {
    ...
    @Transactional(readOnly = true, value = "dbscenarios1TransactionManager")
    @Override
    public List<Persons> findByMultipleIds(List<Integer> personsIds, boolean orderedReturn) {
    ...
    @Transactional(value = "dbscenarios1TransactionManager")
    @Override
    public Persons delete(Integer personsId) {
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbscenarios1 for table Persons to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service dbscenarios1 for table Persons to {} format", options.getExportType());
