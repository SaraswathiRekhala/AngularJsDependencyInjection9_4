 ...
 */
@Service("dbscenarios1.BlobtableProcedureService")
@Validated
public class BlobtableProcedureServiceImpl implements BlobtableProcedureService {
    ...
    @Autowired
    @Qualifier("dbscenarios1.BlobtableProcedureDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbscenarios1 for table BlobtableProcedure to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service dbscenarios1 for table BlobtableProcedure to {} format", options.getExportType());
