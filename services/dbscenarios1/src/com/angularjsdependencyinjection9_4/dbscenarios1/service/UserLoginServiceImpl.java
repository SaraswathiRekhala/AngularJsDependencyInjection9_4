 ...
 * @see UserLogin
 */
@Service("dbscenarios1.UserLoginService")
@Validated
public class UserLoginServiceImpl implements UserLoginService {
    ...
    @Autowired
    @Qualifier("dbscenarios1.UserLoginDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbscenarios1 for table UserLogin to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service dbscenarios1 for table UserLogin to {} format", options.getExportType());
