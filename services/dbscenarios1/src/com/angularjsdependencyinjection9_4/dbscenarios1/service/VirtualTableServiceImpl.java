 ...
 * @see VirtualTable
 */
@Service("dbscenarios1.VirtualTableService")
@Validated
public class VirtualTableServiceImpl implements VirtualTableService {
    ...
    @Autowired
    @Qualifier("dbscenarios1.VirtualTableDao")
    ...
    public VirtualTable getByCharCol(String charCol) {
        ...
        return this.wmGenericDao.findByUniqueKey(charColMap);
    }
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbscenarios1 for table VirtualTable to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service dbscenarios1 for table VirtualTable to {} format", options.getExportType());
