...
import com.angularjsdependencyinjection9_4.dbscenarios1.Department;
 ...
 * @see Department
 */
@Service("dbscenarios1.DepartmentService")
@Validated
public class DepartmentServiceImpl implements DepartmentService {
    ...
    @Autowired
    @Qualifier("dbscenarios1.DepartmentDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbscenarios1 for table Department to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service dbscenarios1 for table Department to {} format", options.getExportType());
