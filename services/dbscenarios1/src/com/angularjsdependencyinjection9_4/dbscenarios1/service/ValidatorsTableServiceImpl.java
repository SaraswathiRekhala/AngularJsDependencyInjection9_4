 ...
 * @see ValidatorsTable
 */
@Service("dbscenarios1.ValidatorsTableService")
@Validated
public class ValidatorsTableServiceImpl implements ValidatorsTableService {
    ...
    @Autowired
    @Qualifier("dbscenarios1.ValidatorsTableDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbscenarios1 for table ValidatorsTable to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service dbscenarios1 for table ValidatorsTable to {} format", options.getExportType());
