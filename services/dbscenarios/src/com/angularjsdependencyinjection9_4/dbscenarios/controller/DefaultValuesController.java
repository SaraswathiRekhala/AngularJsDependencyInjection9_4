...
import com.angularjsdependencyinjection9_4.dbscenarios.DefaultValues;
import com.angularjsdependencyinjection9_4.dbscenarios.service.DefaultValuesService;
...
public class DefaultValuesController {
    ...
    @Autowired
	@Qualifier("dbscenarios.DefaultValuesService")
    ...
    public DefaultValues editDefaultValues(@PathVariable("id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) {
        DefaultValues newDefaultValues = WMMultipartUtils.toObject(multipartHttpServletRequest, DefaultValues.class, "dbscenarios");
