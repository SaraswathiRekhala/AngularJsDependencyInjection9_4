...
import com.angularjsdependencyinjection9_4.dbscenarios.AllTypes;
import com.angularjsdependencyinjection9_4.dbscenarios.service.AllTypesService;
...
public class AllTypesController {
    ...
    public AllTypes createAllTypes(@RequestPart("wm_data_json") AllTypes allTypes, @RequestPart(value = "column19", required = false) MultipartFile _column19) {
		LOGGER.debug("Create AllTypes with information: {}" , allTypes);

    allTypes.setColumn19(WMMultipartUtils.toByteArray(_column19));
