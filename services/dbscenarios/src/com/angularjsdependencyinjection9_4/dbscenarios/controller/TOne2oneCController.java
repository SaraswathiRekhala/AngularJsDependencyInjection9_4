...
import com.angularjsdependencyinjection9_4.dbscenarios.service.TOne2oneCService;
...
public class TOne2oneCController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TOne2oneC getTOne2oneC(@PathVariable("id") Integer id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TOne2oneC editTOne2oneC(@PathVariable("id") Integer id, @RequestBody TOne2oneC tone2oneC) {
        LOGGER.debug("Editing TOne2oneC with id: {}" , tone2oneC.getBigintId());

        tone2oneC.setBigintId(id);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteTOne2oneC(@PathVariable("id") Integer id) {
    ...
    public Page<TOne2oneC> searchTOne2oneCsByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering TOne2oneCs list by query filter:{}", (Object) queryFilters);
    ...
    public Page<TOne2oneC> findTOne2oneCs(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering TOne2oneCs list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportTOne2oneCsAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = TOne2oneC.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> tOne2oneCService.export(exportOptions, pageable, outputStream));
