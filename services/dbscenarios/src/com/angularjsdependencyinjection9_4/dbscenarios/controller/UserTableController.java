...
import com.angularjsdependencyinjection9_4.dbscenarios.service.UserTableService;
...
public class UserTableController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public UserTable getUserTable(@PathVariable("id") Short id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public UserTable editUserTable(@PathVariable("id") Short id, @RequestBody UserTable userTable) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteUserTable(@PathVariable("id") Short id) {
