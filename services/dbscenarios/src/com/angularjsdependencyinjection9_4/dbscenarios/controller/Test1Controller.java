...
import com.angularjsdependencyinjection9_4.dbscenarios.service.Test1Service;
...
public class Test1Controller {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Test1 getTest1(@PathVariable("id") Integer id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public DownloadResponse getTest1BLOBContent(@PathVariable("id") Integer id, @PathVariable("fieldName") String fieldName, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, @RequestParam(value="download", defaultValue = "false") boolean download) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Test1 editTest1(@PathVariable("id") Integer id, @RequestBody Test1 test1) {
        LOGGER.debug("Editing Test1 with id: {}" , test1.getColumn2());
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Test1 editTest1(@PathVariable("id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) {
        Test1 newTest1 = WMMultipartUtils.toObject(multipartHttpServletRequest, Test1.class, "dbscenarios");
        newTest1.setColumn2(id);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteTest1(@PathVariable("id") Integer id) {
    ...
    public Page<Test1> searchTest1sByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering Test1s list by query filter:{}", (Object) queryFilters);
    ...
    public Page<Test1> findTest1s(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering Test1s list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportTest1sAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = Test1.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> test1Service.export(exportOptions, pageable, outputStream));
