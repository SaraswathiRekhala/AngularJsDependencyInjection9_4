...
import com.angularjsdependencyinjection9_4.dbscenarios.TOne2oneP;
import com.angularjsdependencyinjection9_4.dbscenarios.service.TOne2onePService;
...
public class TOne2onePController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TOne2oneP getTOne2oneP(@PathVariable("id") Integer id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TOne2oneP editTOne2oneP(@PathVariable("id") Integer id, @RequestBody TOne2oneP tone2oneP) {
        LOGGER.debug("Editing TOne2oneP with id: {}" , tone2oneP.getBigintId());

        tone2oneP.setBigintId(id);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteTOne2oneP(@PathVariable("id") Integer id) {
