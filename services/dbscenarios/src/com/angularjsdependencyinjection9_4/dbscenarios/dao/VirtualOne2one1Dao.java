...
/**
 * Specifies methods used to obtain and modify VirtualOne2one1 related information
 * which is stored in the database.
 */
@Repository("dbscenarios.VirtualOne2one1Dao")
public class VirtualOne2one1Dao extends WMGenericDaoImpl<VirtualOne2one1, VirtualOne2one1Id> {
