...
/**
 * Specifies methods used to obtain and modify TCrOne2one1 related information
 * which is stored in the database.
 */
@Repository("dbscenarios.TCrOne2one1Dao")
public class TCrOne2one1Dao extends WMGenericDaoImpl<TCrOne2one1, TCrOne2one1Id> {
