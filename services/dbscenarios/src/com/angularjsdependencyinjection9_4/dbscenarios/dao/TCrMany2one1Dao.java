...
/**
 * Specifies methods used to obtain and modify TCrMany2one1 related information
 * which is stored in the database.
 */
@Repository("dbscenarios.TCrMany2one1Dao")
public class TCrMany2one1Dao extends WMGenericDaoImpl<TCrMany2one1, TCrMany2one1Id> {
