...
/**
 * Specifies methods used to obtain and modify VirtualMany2one related information
 * which is stored in the database.
 */
@Repository("dbscenarios.VirtualMany2oneDao")
public class VirtualMany2oneDao extends WMGenericDaoImpl<VirtualMany2one, VirtualMany2oneId> {
