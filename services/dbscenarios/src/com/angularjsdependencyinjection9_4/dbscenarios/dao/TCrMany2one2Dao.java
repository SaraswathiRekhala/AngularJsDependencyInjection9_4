...
/**
 * Specifies methods used to obtain and modify TCrMany2one2 related information
 * which is stored in the database.
 */
@Repository("dbscenarios.TCrMany2one2Dao")
public class TCrMany2one2Dao extends WMGenericDaoImpl<TCrMany2one2, TCrMany2one2Id> {
