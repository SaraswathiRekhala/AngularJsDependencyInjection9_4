...
/**
 * Specifies methods used to obtain and modify TCrOne2one2 related information
 * which is stored in the database.
 */
@Repository("dbscenarios.TCrOne2one2Dao")
public class TCrOne2one2Dao extends WMGenericDaoImpl<TCrOne2one2, TCrOne2one2Id> {
