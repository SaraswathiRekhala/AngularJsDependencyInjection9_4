...
/**
 * Specifies methods used to obtain and modify VirtualMany2one1 related information
 * which is stored in the database.
 */
@Repository("dbscenarios.VirtualMany2one1Dao")
public class VirtualMany2one1Dao extends WMGenericDaoImpl<VirtualMany2one1, VirtualMany2one1Id> {
