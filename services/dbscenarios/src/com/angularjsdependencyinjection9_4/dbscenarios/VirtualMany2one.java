...
/**
 * VirtualMany2one generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`VIRTUAL_MANY2ONE`")
@IdClass(VirtualMany2oneId.class)
public class VirtualMany2one implements Serializable {
