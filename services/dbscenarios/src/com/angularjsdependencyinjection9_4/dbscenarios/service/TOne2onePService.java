...
public interface TOne2onePService {
     ...
     */
    TOne2oneP getById(Integer tone2onepId);
     ...
     * @return TOne2oneP associated with the given tone2onepId.
     */
    TOne2oneP findById(Integer tone2onepId);

	/**
     * Find and return the list of TOne2onePs by given id's.
     *
     ...
     *
     * @param tone2onepIds The id's of the TOne2oneP to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return TOne2onePs associated with the given tone2onepIds.
     */
    List<TOne2oneP> findByMultipleIds(List<Integer> tone2onepIds, boolean orderedReturn);
     ...
     */
    TOne2oneP update(@Valid TOne2oneP tone2oneP);
     ...
     */
    TOne2oneP delete(Integer tone2onepId);

    /**
     * Deletes an existing TOne2oneP with the given object.
     *
     * @param tone2oneP The instance of the TOne2oneP to be deleted; value cannot be null.
     */
    void delete(TOne2oneP tone2oneP);
