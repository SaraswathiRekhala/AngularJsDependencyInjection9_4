...
public interface UserTableService {
     ...
     */
    UserTable getById(Short usertableId);
     ...
     * @return UserTable associated with the given usertableId.
     */
    UserTable findById(Short usertableId);
     ...
     */
    List<UserTable> findByMultipleIds(List<Short> usertableIds, boolean orderedReturn);
     ...
     */
    UserTable delete(Short usertableId);
