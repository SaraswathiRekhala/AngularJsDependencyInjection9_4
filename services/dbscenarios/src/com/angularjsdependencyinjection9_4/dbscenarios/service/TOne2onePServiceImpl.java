...
public class TOne2onePServiceImpl implements TOne2onePService {
    ...
    private WMGenericDao<TOne2oneP, Integer> wmGenericDao;

    public void setWMGenericDao(WMGenericDao<TOne2oneP, Integer> wmGenericDao) {
    ...
    @Override
    public TOne2oneP getById(Integer tone2onepId) {
    ...
    @Transactional(readOnly = true, value = "dbscenariosTransactionManager")
    @Override
    public TOne2oneP findById(Integer tone2onepId) {
        LOGGER.debug("Finding TOne2oneP by id: {}", tone2onepId);
        try {
            return this.wmGenericDao.findById(tone2onepId);
    ...
    @Transactional(readOnly = true, value = "dbscenariosTransactionManager")
    @Override
    public List<TOne2oneP> findByMultipleIds(List<Integer> tone2onepIds, boolean orderedReturn) {
    ...
    @Transactional(value = "dbscenariosTransactionManager")
    @Override
    public TOne2oneP delete(Integer tone2onepId) {
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service dbscenarios for table TOne2oneP to {} format", options.getExportType());
