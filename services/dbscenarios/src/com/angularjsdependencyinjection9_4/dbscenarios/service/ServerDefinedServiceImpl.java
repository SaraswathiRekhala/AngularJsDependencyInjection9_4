 ...
 * @see ServerDefined
 */
@Service("dbscenarios.ServerDefinedService")
@Validated
public class ServerDefinedServiceImpl implements ServerDefinedService {
    ...
    @Autowired
    @Qualifier("dbscenarios.ServerDefinedDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbscenarios for table ServerDefined to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service dbscenarios for table ServerDefined to {} format", options.getExportType());
