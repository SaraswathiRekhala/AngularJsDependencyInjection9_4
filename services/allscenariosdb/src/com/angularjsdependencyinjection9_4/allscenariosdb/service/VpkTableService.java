...
public interface VpkTableService {
     ...
     */
    VpkTable getById(VpkTableId vpktableId);
     ...
     * @return VpkTable associated with the given vpktableId.
     */
    VpkTable findById(VpkTableId vpktableId);
     ...
     */
    List<VpkTable> findByMultipleIds(List<VpkTableId> vpktableIds, boolean orderedReturn);
     ...
     */
    VpkTable delete(VpkTableId vpktableId);
