...
public class ViewBlobTableServiceImpl implements ViewBlobTableService {
    ...
    private WMGenericDao<ViewBlobTable, ViewBlobTableId> wmGenericDao;

    public void setWMGenericDao(WMGenericDao<ViewBlobTable, ViewBlobTableId> wmGenericDao) {
    ...
    @Override
    public ViewBlobTable getById(ViewBlobTableId viewblobtableId) {
    ...
    @Transactional(readOnly = true, value = "allscenariosdbTransactionManager")
    @Override
    public ViewBlobTable findById(ViewBlobTableId viewblobtableId) {
        LOGGER.debug("Finding ViewBlobTable by id: {}", viewblobtableId);
        try {
            return this.wmGenericDao.findById(viewblobtableId);
    ...
    @Transactional(readOnly = true, value = "allscenariosdbTransactionManager")
    @Override
    public List<ViewBlobTable> findByMultipleIds(List<ViewBlobTableId> viewblobtableIds, boolean orderedReturn) {
    ...
    @Transactional(value = "allscenariosdbTransactionManager")
    @Override
    public ViewBlobTable delete(ViewBlobTableId viewblobtableId) {
        ...
        if (deleted == null) {
            ...
            throw new EntityNotFoundException(String.valueOf(viewblobtableId));
        }
