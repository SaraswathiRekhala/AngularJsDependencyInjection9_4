 ...
 * @see DefaultValues
 */
@Service("allscenariosdb.DefaultValuesService")
@Validated
public class DefaultValuesServiceImpl implements DefaultValuesService {
    ...
    @Autowired
    @Qualifier("allscenariosdb.DefaultValuesDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service allscenariosdb for table DefaultValues to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service allscenariosdb for table DefaultValues to {} format", options.getExportType());
