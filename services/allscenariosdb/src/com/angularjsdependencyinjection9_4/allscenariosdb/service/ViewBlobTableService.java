...
public interface ViewBlobTableService {
     ...
     */
    ViewBlobTable getById(ViewBlobTableId viewblobtableId);
     ...
     * @return ViewBlobTable associated with the given viewblobtableId.
     */
    ViewBlobTable findById(ViewBlobTableId viewblobtableId);
     ...
     */
    List<ViewBlobTable> findByMultipleIds(List<ViewBlobTableId> viewblobtableIds, boolean orderedReturn);
     ...
     */
    ViewBlobTable delete(ViewBlobTableId viewblobtableId);
