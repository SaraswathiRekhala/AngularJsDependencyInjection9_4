...
import com.angularjsdependencyinjection9_4.allscenariosdb.DefaultValues;
import com.angularjsdependencyinjection9_4.allscenariosdb.service.DefaultValuesService;
 ...
 * @see DefaultValues
 */
@RestController("allscenariosdb.DefaultValuesController")
@Api(value = "DefaultValuesController", description = "Exposes APIs to work with DefaultValues resource.")
@RequestMapping("/allscenariosdb/DefaultValues")
public class DefaultValuesController {
    ...
    @Autowired
	@Qualifier("allscenariosdb.DefaultValuesService")
    ...
    public DefaultValues editDefaultValues(@PathVariable("id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) {
        DefaultValues newDefaultValues = WMMultipartUtils.toObject(multipartHttpServletRequest, DefaultValues.class, "allscenariosdb");
