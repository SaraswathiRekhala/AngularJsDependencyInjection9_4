...
import com.angularjsdependencyinjection9_4.allscenariosdb.IntLocking;
import com.angularjsdependencyinjection9_4.allscenariosdb.service.IntLockingService;
...
public class IntLockingController {
    ...
    public IntLocking editIntLocking(@PathVariable("id") Integer id, @RequestBody IntLocking intLocking) {
        LOGGER.debug("Editing IntLocking with id: {}" , intLocking.getPkId());

        intLocking.setPkId(id);
