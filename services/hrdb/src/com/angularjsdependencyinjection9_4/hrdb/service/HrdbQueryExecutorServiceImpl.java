...
public class HrdbQueryExecutorServiceImpl implements HrdbQueryExecutorService {
    ...
    @Transactional(value = "hrdbTransactionManager", timeout = 300, readOnly = true)
    @Override
    public void exportSV_ListEmp(List<Integer> deptid, ExportOptions exportOptions, Pageable pageable, OutputStream outputStream) {
        Map<String, Object> params = new HashMap<>(1);

        params.put("DEPTID", deptid);

        QueryProcedureInput queryInput = new QueryProcedureInput("SV_ListEmp", params, SvListEmpResponse.class);
