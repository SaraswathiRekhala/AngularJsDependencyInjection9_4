...
import com.angularjsdependencyinjection9_4.dbexportcheck.service.Table2Service;
...
public class Table2Controller {
    ...
    public Page<Table1> findAssociatedTable1s(@PathVariable("id") Integer id, Pageable pageable) {
        ...
        return table2Service.findAssociatedTable1s(id, pageable);
    }
