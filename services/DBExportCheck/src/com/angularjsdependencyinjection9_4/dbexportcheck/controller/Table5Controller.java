...
import com.angularjsdependencyinjection9_4.dbexportcheck.service.Table5Service;
...
public class Table5Controller {
    ...
    public Page<Table1> findAssociatedTable1s(@PathVariable("id") Integer id, Pageable pageable) {
        ...
        return table5Service.findAssociatedTable1s(id, pageable);
    }
