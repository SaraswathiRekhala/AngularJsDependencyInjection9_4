 ...
 * @see Table2
 */
@Service("DBExportCheck.Table2Service")
@Validated
public class Table2ServiceImpl implements Table2Service {
    ...
    @Autowired
    @Qualifier("DBExportCheck.Table2Dao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service DBExportCheck for table Table2 to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service DBExportCheck for table Table2 to {} format", options.getExportType());
    ...
    public Page<Table1> findAssociatedTable1s(Integer id, Pageable pageable) {
        ...
        queryBuilder.append("table2.id = '" + id + "'");
