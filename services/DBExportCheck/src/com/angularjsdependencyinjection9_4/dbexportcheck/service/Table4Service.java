...
public interface Table4Service {
     ...
     */
    Table4 getById(Integer table4Id);
	...
	/**
     * Find and return the list of Table4s by given id's.
     *
     ...
     *
     * @param table4Ids The id's of the Table4 to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return Table4s associated with the given table4Ids.
     */
    List<Table4> findByMultipleIds(List<Integer> table4Ids, boolean orderedReturn);
     ...
     */
    Table4 update(@Valid Table4 table4);
     ...
     */
    Table4 delete(Integer table4Id);

    /**
     * Deletes an existing Table4 with the given object.
     *
     * @param table4 The instance of the Table4 to be deleted; value cannot be null.
     */
    void delete(Table4 table4);
    ...
    /*
     * Returns the associated table1s for given Table4 id.
     *
     ...
     * @see Page
     */
    Page<Table1> findAssociatedTable1s(Integer id, Pageable pageable);
