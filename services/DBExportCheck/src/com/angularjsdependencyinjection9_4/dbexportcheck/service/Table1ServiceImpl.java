 ...
 * @see Table1
 */
@Service("DBExportCheck.Table1Service")
@Validated
public class Table1ServiceImpl implements Table1Service {
    ...
    @Autowired
    @Qualifier("DBExportCheck.Table1Dao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service DBExportCheck for table Table1 to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service DBExportCheck for table Table1 to {} format", options.getExportType());
