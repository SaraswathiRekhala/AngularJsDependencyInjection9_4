 ...
 * @see Table3
 */
@Service("DBExportCheck.Table3Service")
@Validated
public class Table3ServiceImpl implements Table3Service {
    ...
    @Autowired
    @Qualifier("DBExportCheck.Table3Dao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service DBExportCheck for table Table3 to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service DBExportCheck for table Table3 to {} format", options.getExportType());
    ...
    public Page<Table1> findAssociatedTable1s(Integer id, Pageable pageable) {
        ...
        queryBuilder.append("table3.id = '" + id + "'");
