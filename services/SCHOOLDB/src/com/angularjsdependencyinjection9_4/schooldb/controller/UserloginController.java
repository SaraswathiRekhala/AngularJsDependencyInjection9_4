...
import com.angularjsdependencyinjection9_4.schooldb.service.UserloginService;
 ...
 * @see Userlogin
 */
@RestController("SCHOOLDB.UserloginController")
@Api(value = "UserloginController", description = "Exposes APIs to work with Userlogin resource.")
@RequestMapping("/SCHOOLDB/Userlogin")
public class UserloginController {

    private static final Logger LOGGER = LoggerFactory.getLogger(UserloginController.class);

    @Autowired
	@Qualifier("SCHOOLDB.UserloginService")
