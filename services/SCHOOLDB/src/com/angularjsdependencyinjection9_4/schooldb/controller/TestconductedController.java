...
import com.angularjsdependencyinjection9_4.schooldb.service.TestconductedService;
...
public class TestconductedController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Testconducted getTestconducted(@RequestParam("academicyear") String academicyear, @RequestParam("standardid") Integer standardid, @RequestParam("testconductedid") Integer testconductedid) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Testconducted editTestconducted(@RequestParam("academicyear") String academicyear, @RequestParam("standardid") Integer standardid, @RequestParam("testconductedid") Integer testconductedid, @RequestBody Testconducted testconducted) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteTestconducted(@RequestParam("academicyear") String academicyear, @RequestParam("standardid") Integer standardid, @RequestParam("testconductedid") Integer testconductedid) {
