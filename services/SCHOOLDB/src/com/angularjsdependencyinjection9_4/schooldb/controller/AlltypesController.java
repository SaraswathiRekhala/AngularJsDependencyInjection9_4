...
import com.angularjsdependencyinjection9_4.schooldb.service.AlltypesService;
...
public class AlltypesController {
    ...
    public Alltypes editAlltypes(@PathVariable("id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) {
        Alltypes newAlltypes = WMMultipartUtils.toObject(multipartHttpServletRequest, Alltypes.class, "SCHOOLDB");
