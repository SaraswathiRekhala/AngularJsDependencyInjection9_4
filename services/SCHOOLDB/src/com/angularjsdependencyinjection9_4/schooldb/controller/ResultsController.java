...
import com.angularjsdependencyinjection9_4.schooldb.service.ResultsService;
...
public class ResultsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Results getResults(@RequestParam("academicyear") String academicyear, @RequestParam("standardid") Integer standardid, @RequestParam("studentid") Integer studentid, @RequestParam("testconductedid") Integer testconductedid) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Results editResults(@RequestParam("academicyear") String academicyear, @RequestParam("standardid") Integer standardid, @RequestParam("studentid") Integer studentid, @RequestParam("testconductedid") Integer testconductedid, @RequestBody Results results) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteResults(@RequestParam("academicyear") String academicyear, @RequestParam("standardid") Integer standardid, @RequestParam("studentid") Integer studentid, @RequestParam("testconductedid") Integer testconductedid) {
